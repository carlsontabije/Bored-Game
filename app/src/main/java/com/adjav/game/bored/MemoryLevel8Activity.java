...
public class MemoryLevel8Activity extends AppCompatActivity {
    ...
    private void checkEnd(){
        if(tile_1.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MemoryLevel8Activity.this);
            alertDialogBuilder
                    .setMessage("CONGRATS")
                    .setCancelable(false)
                    .setPositiveButton("NEW", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(getApplicationContext(), MemoryLevel8Activity.class);
